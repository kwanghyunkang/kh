(function($){
  // jQuery
    ...
    // navTitle.eq(1).css({backgroundColor:'#ff0'});

    // 2. 노트북에서 기능 구현
    // 200. gnb_list내부의 li에 마우스 올리면 하위 ul을 나타나게 한다.
    // 201. gnb_list내부 .nav_title에 focus 처리시 기능수행 ('.nav_content' 나타나게)
    // 203. gnbBtn은 1280이상의 기기는 동작하지 않으므로, 
